...
public class RelayCommand : ICommand
{
    ...
    ///     The execute method.
    /// </param>
    public RelayCommand(Action<object> ExecuteMethod) : this(ExecuteMethod,
            null) {}
                        ...
                        Predicate<object> CanExecuteMethod)
    {
        if (ExecuteMethod == null)
        {
            throw new ArgumentNullException("ExecuteMethod",
                                            "Delegate commands cannot be null");
        }
    ...
    public bool CanExecute(object parameter)
    {
        ...
        return this._canExecuteMethod == null ||
               this._canExecuteMethod(parameter);
    }
    ...
    {
        logger.Trace("Entered RaiseCanExecuteChangedEvent()");
...
public sealed class RelayCommand<T> : ICommand
{
    ...
    ///     The execute method.
    /// </param>
    public RelayCommand(Action<T> ExecuteMethod) : this(ExecuteMethod,
            null) {}
    ...
    public bool CanExecute(object parameter)
    {
        ...
        return this._canExecuteMethod == null ||
               this._canExecuteMethod((T)parameter);
    }
